...
<body>
	...
	<header id="header">
		<div class="container clearfix">
			<div id="logo-wrap">
				<h1 id="logo"><a href="index.php" ><img src="images/logo1.png" width="150" alt=""></a></h1>
			</div>
				...
				<nav id="nav">
					<ul class="sf-menu">
						...
						<?php if($user_role == 'admin' || $user_role == 'petugas'): ?>
							<li><a href="list-balita.php">Data</a>
								<ul>
									<li><a href="list-balita.php">Data Anak Posyandu</a></li>
									<li><a href="tambah-balita.php">Tambah Data</a></li>
								</ul>
							</li>
						<?php endif; ?>
